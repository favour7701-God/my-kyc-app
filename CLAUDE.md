...
A shared KYC workflow tool where teams log, track, and verify client compliance records — replacing spreadsheets with a live, multi-user operational dashboard.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296505614+favour7701-God@users.noreply.github.com"
  git config user.name "favour7701-God"
  ```
